...
export default class Bar {
  ...
  prepare_values () {
    ...
    // this.pastDue = this.task.pastDue
  ...
  format_label_innerHTML ({ name, start, end }) {
    // return `${name} (${date_utils.short_hand_format(start)} - ${date_utils.short_hand_format(end)})`
    return `${date_utils.short_hand_format(start)} - ${date_utils.short_hand_format(end)}`
  }

  draw_thumbnail () {
    let x_offset = 10; let y_offset = 2
    let defs, clipPath
  ...
  // update_custom_class () {
  //   console.log(this.group.className)
  //   const { baseVal, animVal } = this.group.className
  //   if (this.group.className.baseVal.includes('unscheduled')) {
  //     this.group.className.baseVal = baseVal.replace('unscheduled-', '')
  //     console.log(this.group.className)
  //   }
  //   if (this.group.className.animVal.includes('unscheduled')) {
  //     this.group.className.animVal = animVal.replace('unscheduled-', '')
  //   }
  // }

  update_label_content ({ new_start_date, new_end_date }) {
    // this.update_custom_class()
